...
def parse_args():
    ...
    parser.add_argument('--train_iter', type=int, default=3000, 
    ...
    parser.add_argument('--num_particle', type=int, default=500, help='number of paricles')
    parser.add_argument('--num_test', type=int, default=10000, help='number of testing paricles')
    ...
    parser.add_argument('--num_ds_dim', type=int, default=24)
...
def main():
    ...
    meta_posterior = Meta_Posterior_adapt(args)
    meta_posterior.train_meta_sampler(args.train_iter)
    meta_posterior.adapt_meta_sampler(args.adapt_iter)
